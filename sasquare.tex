...
To check the top edge, the first row, we do
  ...
  \begin{itemize}
    ...
    \item \textbf{Diagonal ascension} is a step along a diagonal slant. It is a up-left step. It is expressed as $x = n - (b + 1)$. To ensure it is stopped at either the left edge or top edge, we do $x = n + b\left\lceil \frac{r-1}{b} \right\rceil - \left\lceil \frac{c-1}{b} \right\rceil$. 
    \item \textbf{Antidiagonal ascension} is a step along an antidiagonal slant. It is a up-right step. It is expressed as $x = n - (b - 1)$. To ensure it is stopped at either the right edge or top edge, we do $x = n + b\left\lceil \frac{r-1}{b} \right\rceil + (1 - \left\lfloor \frac{c}{b} \right\rfloor)$. 
