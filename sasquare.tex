...
\begin{document}
    ...
    An anti-diagonal is the opposite of the diagonal. An anti-diagonal has cells where $r = b - c + 1$ where $b$ is the base, where $b = r + c$. It is the longest ascending slant. Its two end cells are always $a_{b,1}$ and $a_{1,b}$
