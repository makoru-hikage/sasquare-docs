...
\begin{document}
    ...
    The center of a square grid will vary on whether its base is even or not. There is only one cell in the center of a square when its base is odd. When its base is even, there will always be four cells in the size of a 2-square. We will call the squares with an odd base an odd-base square, and the squares with an even base is a even-base square.
