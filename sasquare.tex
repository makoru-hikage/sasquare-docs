...
\begin{document}
    ...
    \begin{figure}[ht]
        ...
        \caption{Two square grids are labeled differently, they are indexed as elements of a sequence and a matrix respectively} \label{1.1f1}
    \end{figure}

    In Figure \ref{1.1f1}, the base of the square grids is 3 and the total number of cells is 9. In matrix notation, the rows and columns are indexed accordingly. We denote the elements of the right grid with $i_{r,c}$ where $r$ is the row index and $c$ is the column index. In this example, we assume that both grids represent the same array.
    ...
    \subsubsection*{Example: Row and Column of Cell 17 in 5-Square}
    \begin{figure*}[ht]
        \centering
    ...
    \section{The Intersection}
    All cells belong to only one row and one column, hence $i_n$ can become $a_{r,c}$. An intersection is where a row and a column meet; they can only meet in one cell. 
\end{document}