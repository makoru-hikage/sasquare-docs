...
\begin{document}
    ...
    We shall call the index of a descending slant a descending index or $\kappa$ index. To determine the $\kappa$ index of the cell, we shall use function $\kappa$.
    \begin{equation}
        \kappa(b,n) = b + \delta(b,n)
    \end{equation}

    We shall call the index of an ascending slant an ascending index or $\upsilon$ index. To determine the $\upsilon$ index of the cell, we shall use function $\upsilon$.
    \begin{equation}
