...
\begin{document}
    ...
    \begin{equation}
      x = n - \left\lceil \frac{n \bmod b}{b} \right\rceil
    \end{equation}
...
To check if we hit the bottom edge, we do
    ...
    \end{equation}
The function $\operatorname{r}$ or this part $\left\lfloor \frac{n}{b} \right\rfloor-1$ is used to check if we hit the bottom edge, the last row.
...
To check the top edge, the first row, we do
    \begin{equation}
      x = n + b\left\lceil \frac{\left\lfloor \frac{n}{b} \right\rfloor}{b} \right\rceil
    \end{equation}
