...
\begin{document}
    ...
    \begin{equation*}
        ...
        \end{split}
    \end{equation*}
    Since there are only 3 cells in the slant, we will enumerate up the 3rd cell of descending 3.
    \begin{equation*}
        \begin{split}
        ...
        \end{split}
    \end{equation*}
    Cell 17 is the 2nd cell of descending slant 3 for $\kappa_{3,2}5 = 17$
    \begin{figure*}[ht]
        \tikzset{highlight/.style={
            line width=0.8pt,
            draw=gray!80,
