...
\begin{document}
    ...
    \subsection{Center of a Row and a Column}
    ...
    To find the cell index of the center of a row. For example, we will find the center of row 2 of a 5-square. Let $c$ be equal to the center of the base and $r$ be the chosen row. 
    \begin{equation}
        \begin{split}
            c &= M(b) \\
            c &= M(5) \\
