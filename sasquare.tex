...
\begin{document}
    ...
    A matrix has a special set of elements called a diagonal. A diagonal consists of elements where $r = c$. In a square grid, a diagonal is the longest descending slant.
